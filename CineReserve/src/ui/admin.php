        ...
        <main>
            ...
            <?php else: ?>
                ...
                <div class="admin-grid">
                    ...
                    <!-- FİLMLERİ LİSTELEME VE SİLME KARTLARI -->
                    <div class="admin-card">
                        <h2><span class="icon">🎬</span> Aktif Filmler & Koltuk Durumu</h2>
                        <ul class="admin-list" id="adminMovieList">
                            <!-- JavaScript ile (api üzerinden) veritabanından çekip burayı dolduruyorum -->
                        </ul>
                    </div>

                    <!-- KULLANICILARIN İSTEDİĞİ FİLMLER -->
                    <div class="admin-card">
                    ...
                    <!-- KAYITLI KULLANICILAR (VE YETKİ VERME) -->
                    <div class="admin-card">
