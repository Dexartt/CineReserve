    ...
    try {
        ...
        if (result.success) {
            ...
            sortedRequests.forEach(req => {
                ...
                `;
                // Sayıya göre metni ayarlıyorum (ilerde belki değiştiririm ama şimdilik İstek yazsın)
    ...
    try {
        ...
        if (result.success) {
            result.data.forEach(userObj => {
                ...
                // Kendi hesabımın (enes12) yetkisini yanlışlıkla almayayım diye buraya ufak bir kilit koydum
